...
*Features:* KSU $(parse_bool "$KSU"), SuSFS $(parse_bool "$SUSFS"), LXC $(parse_bool "$LXC"), KPM $(parse_bool "$KPM"), BBG $(parse_bool "$BBG"), BBRv3 $(parse_bool "$BBR_V3"), Stock config $(parse_bool "$STOCK_CONFIG")
EOF
    )
